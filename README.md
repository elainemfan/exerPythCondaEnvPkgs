...
|     ---     |                     ---                     |
|What is the purpose of having different environments?     |(This allows mulitple projects at the same time in an efficient manner)|
|What is the default package manager in Python?            |(Conda)|
|How do you manage environments and packages in Anaconda?  |(Use the navigator)|
|`conda list`       |(A list of packages)|
|`conda env list`       |(A list of environments)|
|How do you keep your base environment unchanged?       |(Create a separate environment)|
|What is the link to the Conda cheat sheet? (link in video notes is broken)      |(Cheatsheet to navigate the Conda basics and environments)|
|`conda create --name XXXX`       |(ai37 python=3.8.8)|
|`source activate XXXX`       |(ai37)|
|`conda install YYYY`       |(numpy)|
|channels in Conda       |(Location where Conda installs the package)|
|`conda install -c ZZZZ YYYY`       |(pytorch)|
|`conda config --show channels`       |(It showes the base channel)|
|`conda config --add channels ZZZZ`       |(conda-forge)|
|conda-forge.org       |(Packages for the public)|
|`source deactivate`       |(Takes to the base channel)|
|`conda config --get channels`       |(shows channels with different priorities)|

* After creating the environments he created in the video on your computer, what would the results of running the command `conda env list` look like with the da35 environment activated. Paste the output from your command prompt in the code block below.

```
#Paste your results here.
(base) elaines-air:~ ElaineFan$ conda activate da35
(da35) elaines-air:~ ElaineFan$ conda env list
# conda environments:
#
base                     /Users/ElaineFan/opt/anaconda3
ai37                     /Users/ElaineFan/opt/anaconda3/envs/ai37
da35                  *  /Users/ElaineFan/opt/anaconda3/envs/da35

(da35) elaines-air:~ ElaineFan$ 
...
conda env remove --ai37
conda env remove --da35
```
## 2021 Update
